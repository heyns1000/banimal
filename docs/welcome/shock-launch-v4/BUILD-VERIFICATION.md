# Shock Launch v4 — Alignment Audit & Build Verification Manual

Backup reference for the Banimal Connector / Sam Fox™ CI Guide build process,
covering `docs/welcome/shock-launch-v4/`. Logs every layout/alignment defect
...
Issue "8" was found after that merge and is fixed here, in the new
`shock-launch-v4/`. Everything from here on is tracked against v4.
...
`docs/welcome/shock-launch-v3/` is v3, this directory is v4. **Once a
